  ...
  const labels: ReadonlyLabels =
    locale === "zh-CN"
      ...
      : locale === "ja-JP"
        ? {
            history: "思考過程",
            computerUse: "コンピューター操作",
            explore: "探索",
            execute: "実行",
            changes: "変更",
            artifactPreview: "ファイルをダウンロード",
            markerCompact: "コンテキストを圧縮しました",
            markerModelChange: "モデルを切り替えました",
            unsupportedRows: "一部の内容を表示するには新しいバージョンのZCodeが必要です",
          }
        : {
            history: "Reasoning",
