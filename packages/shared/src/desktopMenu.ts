...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  ...
  "ja-JP": {
    ...
    "titleBar.menu.edit": "編集",
    "titleBar.menu.view": "表示",
    "titleBar.menu.window": "ウインドウ",
    "titleBar.menu.help": "ヘルプ",
    "titleBar.menu.file.newTask": "新しいタスク",
    "titleBar.menu.file.openWorkspace": "ワークスペースを開く",
    "titleBar.menu.file.closeWindow": "ウインドウを閉じる",
    "titleBar.menu.edit.undo": "元に戻す",
    "titleBar.menu.edit.redo": "やり直す",
    "titleBar.menu.edit.cut": "切り取り",
    "titleBar.menu.edit.copy": "コピー",
    "titleBar.menu.edit.paste": "貼り付け",
    "titleBar.menu.edit.delete": "削除",
    "titleBar.menu.edit.selectAll": "すべて選択",
    "titleBar.menu.view.toggleFullScreen": "フルスクリーンを切り替える",
    "titleBar.menu.view.actualSize": "実際のサイズ",
    "titleBar.menu.view.zoomIn": "拡大",
    "titleBar.menu.view.zoomOut": "縮小",
    "titleBar.menu.window.minimize": "最小化",
    "titleBar.menu.window.zoom": "ズーム",
    "titleBar.menu.window.bringAllToFront": "すべてを手前に移動",
    "titleBar.menu.app.services": "サービス",
    "titleBar.menu.app.hide": "{appName}を隠す",
    "titleBar.menu.app.hideOthers": "ほかを隠す",
    "titleBar.menu.app.showAll": "すべてを表示",
    "titleBar.menu.app.quit": "{appName}を終了",
    "titleBar.menu.help.about": "ZCodeについて",
    "titleBar.menu.help.whatsNew": "新機能",
    "titleBar.menu.help.checkForUpdates": "アップデートを確認",
    "titleBar.menu.help.toggleDevTools": "開発者ツールを切り替える",
    "titleBar.menu.help.resourceManager": "リソースマネージャー",
    "titleBar.menu.help.toggleZCodeStdioTap": "Agent stdio通信を記録",
    "titleBar.menu.help.zcodeEndpoint": "ZCode Endpoint",
    "titleBar.menu.help.zcodeEndpoint.production": "Production（既定）",
    "titleBar.menu.help.zcodeEndpoint.test": "Test",
    "titleBar.menu.help.zcodeEndpoint.custom": "カスタム...",
    "titleBar.menu.help.zcodeEndpoint.reset": "既定に戻す",
    "titleBar.menu.help.feedback": "フィードバック",
    "titleBar.menu.help.exportLogs": "ログを書き出す",
    "titleBar.menu.help.clearAllData": "すべてのデータを消去",
    "desktopMenu.help.checkingForUpdates": "アップデートを確認中...",
    "desktopMenu.help.updateAvailableVersion": "アップデート {version} を利用できます",
    "desktopMenu.help.downloadingUpdateVersion": "アップデート {version} をダウンロード中...",
    "desktopMenu.help.downloadingUpdateProgress": "アップデートをダウンロード中... {progress}",
    "desktopMenu.help.restartToUpdate": "再起動して更新（{version}）",
    "dock.menu.showCurrentWindow": "現在のウインドウを表示",
    "tray.tooltip": "ZCode",
    "tray.menu.openZCode": "ZCodeを開く",
    "tray.menu.quit": "終了",
  },
  "en-US": {
